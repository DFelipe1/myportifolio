...
import { Blob } from './componnets/Blob'

import { ModalProject } from './componnets/ModalProject'

ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    <div className="w-full md:max-w-[700px] lg:max-w-[900px]  xl:max-w-[1140px] md:mx-auto p-3 antialiased">
      <Header/>
